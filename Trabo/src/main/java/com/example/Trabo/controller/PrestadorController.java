...
public class PrestadorController {
    ...
    @SecurityRequirement(name = "bearerAuth")
    @Operation(summary = "Atualizar próprio perfil (requer login como PRESTADOR)")
    public ResponseEntity<PrestadorResponse> atualizarPerfil(
            @Valid @RequestBody AtualizarPrestadorRequest request) {
        return ResponseEntity.ok(prestadorService.atualizarPerfil(request));
    }
}
