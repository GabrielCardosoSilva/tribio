<div align="center">
  ...
  <h1>Trabio</h1>
  <p><strong>A plataforma ideal para conectar clientes e prestadores de serviços autônomos de forma rápida e segura.</strong></p>
</div>
...
**Trabio** é um sistema web desenvolvido para revolucionar a forma como profissionais autônomos locais divulgam seus serviços e como clientes encontram a ajuda ideal para suas necessidades. 
...
### Frontend
- **HTML5 & CSS3** com design moderno (sombras sutis, grid layout e cards arredondados)
- **Vanilla JavaScript** (ES6+) para interações do cliente, controle do Painel e consumo das APIs RESTful
